...
We use multiple runs since two of our methods use some random choices: CD uses the  stochastic WHERE clustering algorithm~\cite{Menzies2013:local}
...
In implement Scott-Knott using our data,
  we
